...
namespace aprilparticle
{
	...
	void Emitter::_setupTriangleBatch()
	{
		...
		this->_triangleBatch = new april::ColoredTexturedVertex[this->limit * VERTICES_PER_PARTICLE];
		for_iterx (this->_i, 0, this->limit)
		{
			this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 0].u = 0.0f;	this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 0].v = 0.0f;
			this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 1].u = 1.0f;	this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 1].v = 0.0f;
			this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 2].u = 0.0f;	this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 2].v = 1.0f;
			this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 3].u = 1.0f;	this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 3].v = 0.0f;
			this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 4].u = 0.0f;	this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 4].v = 1.0f;
			this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 5].u = 1.0f;	this->_triangleBatch[this->_i * VERTICES_PER_PARTICLE + 5].v = 1.0f;
		}
	}
